...
#ifndef LV_ATTRIBUTE_IMG_PICTOGRAMMERS-MATERIAL-WIFI
#define LV_ATTRIBUTE_IMG_PICTOGRAMMERS-MATERIAL-WIFI
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_PICTOGRAMMERS-MATERIAL-WIFI uint8_t Pictogrammers-Material-Wifi_map[] = {
...
const lv_img_dsc_t Pictogrammers-Material-Wifi = {
  ...
  .data = Pictogrammers-Material-Wifi_map,
};
